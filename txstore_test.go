...
func TestTxStore_PopulateAdrs(t *testing.T) {
	...
	tx := wire.NewMsgTx(1)
	tx.BtcDecode(r, 1, wire.BaseEncoding)
...
func TestTxStore_CheckDoubleSpends(t *testing.T) {
	...
	r := bytes.NewReader(tx1Bytes)
	tx1 := wire.NewMsgTx(1)
	tx1.BtcDecode(r, 1, wire.BaseEncoding)
...
func TestTxStore_markAsDead(t *testing.T) {
	...
	tx2 := wire.NewMsgTx(1)
	tx2.BtcDecode(r, 1, wire.BaseEncoding)
	...
	tx3 := wire.NewMsgTx(1)
	tx3.BtcDecode(r, 1, wire.BaseEncoding)
...
func TestTxStore_Ingest(t *testing.T) {
	...
	tx4 := wire.NewMsgTx(1)
	tx4.BtcDecode(r, 1, wire.BaseEncoding)
	...
	tx5 := wire.NewMsgTx(1)
	tx5.BtcDecode(r, 1, wire.BaseEncoding)
